...
const translations = {
  en: {
    ...
    'rsvp.dietary.placeholder': 'Any dietary restrictions or allergies...',
  ...
  pt: {
    ...
    'rsvp.dietary.placeholder': 'Alguma restrição alimentar ou alergia...',
